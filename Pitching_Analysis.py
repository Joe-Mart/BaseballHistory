...
def main():
    ...
    logging.basicConfig(filename='Pitching_Analysis.log', encoding='utf-8', level=logging.INFO)
    ...
    # For some reason, had to make the yearID field a float here in order for it to display correctly.
    ...
    # Once the process is completed, log to the log file that the process is completed.
